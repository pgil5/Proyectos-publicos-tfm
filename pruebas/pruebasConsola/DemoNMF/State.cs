...
namespace DemoNMF.FSM
{
    ...
    public partial class State : ModelElement, IState, IModelElement
    {
        ...
        private static Lazy<ITypedElement> _isAcceptingAttribute = new Lazy<ITypedElement>(RetrieveIsAcceptingAttribute);
        ...
        /// </summary>
        [DisplayNameAttribute("isAccepting")]
        [CategoryAttribute("State")]
        ...
        public bool IsAccepting
        {
            ...
            set
            {
                if ((this._isAccepting != value))
                {
                    bool old = this._isAccepting;
                    ValueChangedEventArgs e = new ValueChangedEventArgs(old, value);
                    this.OnIsAcceptingChanging(e);
                    this.OnPropertyChanging("IsAccepting", e, _isAcceptingAttribute);
                    this._isAccepting = value;
                    this.OnIsAcceptingChanged(e);
                    this.OnPropertyChanged("IsAccepting", e, _isAcceptingAttribute);
                }
            }
        }
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://github.com/NMFCode/Examples/FiniteStateMachines#//State")));
                }
        ...
        /// <summary>
        /// Gets fired before the IsAccepting property changes its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> IsAcceptingChanging;
        
        /// <summary>
        /// Gets fired when the IsAccepting property changed its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> IsAcceptingChanged;
        
        private static ITypedElement RetrieveNameAttribute()
        {
            return ((ITypedElement)(((ModelElement)(DemoNMF.FSM.State.ClassInstance)).Resolve("name")));
        }
        ...
        private static ITypedElement RetrieveIsAcceptingAttribute()
        {
            return ((ITypedElement)(((ModelElement)(DemoNMF.FSM.State.ClassInstance)).Resolve("isAccepting")));
        }
        
        /// <summary>
        /// Raises the IsAcceptingChanging event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnIsAcceptingChanging(ValueChangedEventArgs eventArgs)
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.IsAcceptingChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnIsAcceptingChanged(ValueChangedEventArgs eventArgs)
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.IsAcceptingChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            return ((ITypedElement)(((ModelElement)(DemoNMF.FSM.State.ClassInstance)).Resolve("outgoing")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(DemoNMF.FSM.State.ClassInstance)).Resolve("incoming")));
        }
        ...
        protected override void SetFeature(string feature, object value)
        {
            ...
            if ((feature == "ISACCEPTING"))
            {
                this.IsAccepting = ((bool)(value));
                return;
            }
        ...
        protected override NMF.Expressions.INotifyExpression<object> GetExpressionForAttribute(string attribute)
        {
            ...
            if ((attribute == "ISACCEPTING"))
            {
                return Observable.Box(new IsAcceptingProxy(this));
            }
        ...
        /// <summary>
        /// Represents a proxy to represent an incremental access to the isAccepting property
        /// </summary>
        private sealed class IsAcceptingProxy : ModelPropertyChange<IState, bool>
        {
            ...
            /// </summary>
            /// <param name="modelElement">The model instance element for which to create the property access proxy</param>
            public IsAcceptingProxy(IState modelElement) : 
                    base(modelElement, "isAccepting")
            {
            }
            ...
            public override bool Value
            {
                get
                {
                    return this.ModelElement.IsAccepting;
                }
                set
                {
                    this.ModelElement.IsAccepting = value;
                }
            }
        }
    }
