...
/**
 * This is the item provider adapter for a {@link BIMMixer.Category} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CategoryItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BIMMixerPackage.Literals.CATEGORY__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BIMMixerPackage.Literals.CATEGORY__SUB_CATEGORIES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Category.class)) {
			case BIMMixerPackage.CATEGORY__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case BIMMixerPackage.CATEGORY__SUB_CATEGORIES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BIMMixerPackage.Literals.CATEGORY__SUB_CATEGORIES,
				 BIMMixerFactory.eINSTANCE.createSubcategory()));
	}
