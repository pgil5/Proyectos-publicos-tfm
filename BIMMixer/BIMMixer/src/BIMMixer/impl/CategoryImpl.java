 ...
 * </p>
 * <ul>
 *   <li>{@link BIMMixer.impl.CategoryImpl#getName <em>Name</em>}</li>
 *   <li>{@link BIMMixer.impl.CategoryImpl#getSubCategories <em>Sub Categories</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CategoryImpl extends MinimalEObjectImpl.Container implements Category {
	...
	protected EClass eStaticClass() {
		return BIMMixerPackage.Literals.CATEGORY;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BIMMixerPackage.CATEGORY__NAME, oldName, name));
	}
	...
	public EList<Subcategory> getSubCategories() {
		if (subCategories == null) {
			subCategories = new EObjectContainmentEList<Subcategory>(Subcategory.class, this, BIMMixerPackage.CATEGORY__SUB_CATEGORIES);
		}
